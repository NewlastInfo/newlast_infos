...
from dingTalk_medical_care import DingTalks
from selenium.webdriver import ChromeOptions


class MedicalCare:
    def __init__(self):
        self.url = "https://fund.eastmoney.com/001558.html"
    ...
    def get_medical_care_code(self):
...
def return_medical_care():
    while True:
        try:
            medical_care = MedicalCare()
            medical_care.get_medical_care_code()
        except Exception as e:
            print(f'error is {e}')
